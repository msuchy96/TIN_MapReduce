package MapReduce.Thrift.SimpleThriftWorker;
    ...
    public void Main(){
        ...
        try{
            while ( !f1.isDone() && !f2.isDone()){
                ...
                System.out.println("Server work success status: " + String.valueOf(f1.get()));
                System.out.println("Client work success status: " + String.valueOf(f2.get()));
            }
        } catch (Exception ex){
